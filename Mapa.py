...
def obtener_ruta(origen, destino):
    ...
    print(f"Buscando ruta de: '{origen}' a '{destino}'") # Agrega esto
    ...
    for step in pasos:
        ...
        start = (step['start_location']['lat'],
                 step['start_location']['lng'])

        end = (step['end_location']['lat'],
...
def generar_mapa(camino, nombre_archivo="mi_ruta.html"):
    ...
    # Creamos el mapa centrado en el primer punto
