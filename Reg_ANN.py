...
plt.savefig('1_distribucion_precios_Carros.png')
plt.close()
...
plt.savefig('2_matriz_correlacion_precios_Carros.png')
plt.close()
...
plt.legend()
plt.savefig('3_historial_entrenamiento_Carros.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('4_grafica_discrepancias_Carros.png')
plt.close()
